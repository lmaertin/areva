 ...
 * @generated
 */
public class ResourcerelationsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ResourcerelationsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResourcerelationsPackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.SPECIFICATION: {
				Specification specification = (Specification)theEObject;
				T result = caseSpecification(specification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.PLATFORM: {
				Platform platform = (Platform)theEObject;
				T result = casePlatform(platform);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.RESOURCE_OPTIONS: {
				ResourceOptions resourceOptions = (ResourceOptions)theEObject;
				T result = caseResourceOptions(resourceOptions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.RULE: {
				Rule rule = (Rule)theEObject;
				T result = caseRule(rule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.RESOURCE_VARIABLE: {
			...
			case ResourcerelationsPackage.IMPLIES: {
				Implies implies = (Implies)theEObject;
				T result = caseImplies(implies);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResourcerelationsPackage.NOT: {
			...
			case ResourcerelationsPackage.OR: {
				Or or = (Or)theEObject;
				T result = caseOr(or);
			...
			case ResourcerelationsPackage.AND: {
			...
			case ResourcerelationsPackage.RESOURCE_OPTIONS_VARIABLE: {
				ResourceOptionsVariable resourceOptionsVariable = (ResourceOptionsVariable)theEObject;
				T result = caseResourceOptionsVariable(resourceOptionsVariable);
				if (result == null) result = caseExpression(resourceOptionsVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Options Variable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Options Variable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceOptionsVariable(ResourceOptionsVariable object) {
		return null;
	}
