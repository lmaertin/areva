 ...
 * </p>
 * <ul>
 *   <li>{@link de.tubs.areva.emf.model.qadag.impl.LeafNodeImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link de.tubs.areva.emf.model.qadag.impl.LeafNodeImpl#getMaxValue <em>Max Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LeafNodeImpl extends NodeImpl implements LeafNode {
	...
	protected EClass eStaticClass() {
		return QadagPackage.Literals.LEAF_NODE;
	}
	...
	public void setMinValue(double newMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QadagPackage.LEAF_NODE__MIN_VALUE, oldMinValue, minValue));
	}
	...
	public void setMaxValue(double newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QadagPackage.LEAF_NODE__MAX_VALUE, oldMaxValue, maxValue));
	}
