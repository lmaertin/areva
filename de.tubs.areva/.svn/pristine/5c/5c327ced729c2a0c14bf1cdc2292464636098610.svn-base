...
public class NodePropertySource implements IPropertySource {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		...
		if(node instanceof DARGZestNode) {
			
			DARGZestNode zestNode = (DARGZestNode) node;
			
			if(zestNode.getArchitecture() instanceof Architecture) {
				
				return new IPropertyDescriptor[] {NAME_PROPERTY_DESCRIPTOR, RESOURCES_PROPERTY_DESCRIPTOR, RESOURCESAMOUNT_PROPERTY_DESCRIPTOR};
			}
		}
	...
	public Object getPropertyValue(Object id) {
		...
		if (NAME_PROPERTY_DESCRIPTOR.getId().equals(id)) {
			...
			DARGZestNode zestNode = (DARGZestNode) node;
			return ((Architecture)zestNode.architecture).getQuality();
			...
			for(Resource resource: zestNode.architecture.getBoundResources()) {
			...
			return zestNode.getArchitecture().getBoundResources().size();
		} 
