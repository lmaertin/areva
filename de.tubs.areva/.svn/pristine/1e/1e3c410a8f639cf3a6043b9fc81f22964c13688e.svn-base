...
public class EdgePropertySource implements IPropertySource {
	...
	public Object getPropertyValue(Object id) {
		...
		if (RESOURCES_LOST_PROPERTY_DESCRIPTOR.getId().equals(id)) {
			...
			List<String> resourcesLost = ResourceHelper.complement(zestEdge.getSourceArchitecture().getBoundResources(), zestEdge.getTargetArchitecture().getBoundResources());
			
			String output = "";
			
			for(String resource: resourcesLost) {
				output += "," + resource;
			}
