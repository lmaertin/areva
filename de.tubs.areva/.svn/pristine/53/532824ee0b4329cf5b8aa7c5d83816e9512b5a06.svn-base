...
public class SelectFaultyResourcesPage extends WizardPage {

	private Composite container;
	
	String input = "";
	
	public SelectFaultyResourcesPage() {
		super("Select Faulty Resources");
		setTitle("Select Faulty Resources");
		setDescription("Select faulty resources in order of failure");
	}
