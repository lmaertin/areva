...
public class CreateDARGWizardPageTwo extends WizardPage {

private Composite container;
	
	public URI candidatesFile = null;
	
	public CreateDARGWizardPageTwo() {
		super("Choose candidates file");
		setTitle("Choose candidates file");
		setDescription("Choose DSE's candidates file (.csv) corresponding to the chosen allocation model.");
	}
