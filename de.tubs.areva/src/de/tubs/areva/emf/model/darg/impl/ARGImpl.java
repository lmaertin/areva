 ...
 *   <li>{@link de.tubs.areva.emf.model.darg.impl.ARGImpl#getThreshold <em>Threshold</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ARGImpl extends MinimalEObjectImpl.Container implements ARG {
	...
	public void setThreshold(int newThreshold) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DargPackage.ARG__THRESHOLD, oldThreshold, threshold));
	}
