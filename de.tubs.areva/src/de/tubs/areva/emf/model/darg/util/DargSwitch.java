 ...
 * @generated
 */
public class DargSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DargPackage.ARG: {
				ARG arg = (ARG)theEObject;
				T result = caseARG(arg);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DargPackage.ARCHITECTURE: {
				Architecture architecture = (Architecture)theEObject;
				T result = caseArchitecture(architecture);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DargPackage.QUALITY_ASSIGNMENT: {
				QualityAssignment qualityAssignment = (QualityAssignment)theEObject;
				T result = caseQualityAssignment(qualityAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quality Assignment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quality Assignment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQualityAssignment(QualityAssignment object) {
		return null;
	}
