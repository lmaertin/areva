...
public class OpmodePackageImpl extends EPackageImpl implements OpmodePackage {
	 ...
	 * @generated
	 */
	public EAttribute getOperatingModeSelection_Name() {
		return (EAttribute)operatingModeSelectionEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(operatingModeSelectionEClass, OPERATING_MODE_SELECTION__NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOperatingModeSelection_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, OperatingModeSelection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
