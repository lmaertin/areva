 ...
 * @generated
 */
public class QadagSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QadagPackage.QADAG: {
				QADAG qadag = (QADAG)theEObject;
				T result = caseQADAG(qadag);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QadagPackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QadagPackage.LEAF_NODE: {
			...
			case QadagPackage.COMPOSITE_NODE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>QADAG</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>QADAG</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQADAG(QADAG object) {
		return null;
	}
