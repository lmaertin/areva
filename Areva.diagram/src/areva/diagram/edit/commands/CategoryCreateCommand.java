...
public class CategoryCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Evaluation container;

	/**
	 * @generated
	 */
	public CategoryCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Category) {
			return false;
		}
		if (getSource() == null) {
		...
		return ArevaBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCategory_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Category newElement = ArevaFactory.eINSTANCE.createCategory();
		getContainer().getCategories().add(newElement);
		newElement.getCategories().add(getSource());
		newElement.getCategories().add(getTarget());
	 ...
	 * @generated
	 */
	public Evaluation getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static Evaluation deduceContainer(EObject source, EObject target) {
