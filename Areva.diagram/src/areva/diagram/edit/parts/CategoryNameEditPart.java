 ...
 * @generated
 */
public class CategoryNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ArevaVisualIDRegistry
						.getType(areva.diagram.edit.parts.CategoryNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArevaParserProvider
					.getParser(
							ArevaElementTypes.Category_4001,
							getParserElement(),
							ArevaVisualIDRegistry
									.getType(areva.diagram.edit.parts.CategoryNameEditPart.VISUAL_ID));
		}
