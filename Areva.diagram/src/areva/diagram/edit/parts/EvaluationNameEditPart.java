...
import areva.diagram.edit.policies.ArevaTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EvaluationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EvaluationNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ArevaTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return ArevaElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ArevaParserProvider
					.getParser(
							ArevaElementTypes.Evaluation_2001,
							getParserElement(),
							ArevaVisualIDRegistry
									.getType(areva.diagram.edit.parts.EvaluationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ArevaEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
