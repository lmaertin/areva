...
public class DSEConstantsContainer {
	...
	public static final String AREVA_FILE = "arevaFile";
	...
	public static final String[] AREVA_MODEL_EXTENSION = new String[] { "*.resourcerelations" };
	...
	public enum QualityAttribute {
		...
		AREVA_QUALITY {
			public String getName() {	return "de.uka.ipd.sdq.dsexplore.areva";	}
			public String getPrettyName() { return "Areva"; }};
		...
		public static QualityAttribute getQualityAttribute(String name){
			if (name.equals(PERFORMANCE_QUALITY.getName())){
				...
				return NQR_QUALITY;
			} else if (name.equals(AREVA_QUALITY.getName())){
				return AREVA_QUALITY;
			} else {
				return null;
			}
		}
	...
	/** Default URI for the areva model file. */
	public static final String DEFAULT_AREVA_MODEL_FILE = "";
