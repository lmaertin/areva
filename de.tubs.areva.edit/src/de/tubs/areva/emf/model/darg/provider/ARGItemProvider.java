...
/**
 * This is the item provider adapter for a {@link de.tubs.areva.emf.model.darg.ARG} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ARGItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addQadagPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DargPackage.Literals.ARG__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Qadag feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addQadagPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ARG_qadag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ARG_qadag_feature", "_UI_ARG_type"),
				 DargPackage.Literals.ARG__QADAG,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addThresholdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ARG_threshold_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ARG_threshold_feature", "_UI_ARG_type"),
				 DargPackage.Literals.ARG__THRESHOLD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DargPackage.Literals.ARG__ARCHITECTURES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ARG.class)) {
			...
			case DargPackage.ARG__THRESHOLD:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DargPackage.Literals.ARG__ARCHITECTURES,
				 DargFactory.eINSTANCE.createArchitecture()));
	}
