...
/**
 * This is the item provider adapter for a {@link areva.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArevaPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPercentagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_percentage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_percentage_feature", "_UI_Category_type"),
				 ArevaPackage.Literals.CATEGORY__PERCENTAGE,
				 true,
				 false,
				 false,
	...
	protected void addRatingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_rating_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_rating_feature", "_UI_Category_type"),
				 ArevaPackage.Literals.CATEGORY__RATING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArevaPackage.Literals.CATEGORY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMustHavePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_mustHave_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_mustHave_feature", "_UI_Category_type"),
				 ArevaPackage.Literals.CATEGORY__MUST_HAVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_unit_feature", "_UI_Category_type"),
				 ArevaPackage.Literals.CATEGORY__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArevaPackage.Literals.CATEGORY__CATEGORIES);
			childrenFeatures.add(ArevaPackage.Literals.CATEGORY__ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArevaPackage.Literals.CATEGORY__CATEGORIES,
				 ArevaFactory.eINSTANCE.createCategory()));

		newChildDescriptors.add
			(createChildParameter
				(ArevaPackage.Literals.CATEGORY__ELEMENTS,
				 ArevaFactory.eINSTANCE.createElement()));
	}
